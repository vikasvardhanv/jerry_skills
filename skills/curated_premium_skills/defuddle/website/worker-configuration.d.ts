/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 510374357cdcbf0f8183f88fcdd6c886)
// Runtime types generated with workerd@1.20260305.0 2024-12-30 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ApiKeyBalanceDO" | "CheckoutFulfillmentDO";
	}
	interface Env {
		RATE_LIMIT: KVNamespace;
		STRIPE_SECRET_KEY: string;
		API_KEY_BALANCES: DurableObjectNamespace<import("./src/index").ApiKeyBalanceDO>;
		CHECKOUT_FULFILLMENTS: DurableObjectNamespace<import("./src/index").CheckoutFulfillmentDO>;
	}
}
